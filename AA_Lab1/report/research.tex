...
\begin{figure}
	\center{\includegraphics[scale=1]{inc/img/LevLenMemory}}
	\caption{Оценка памяти алгоритма LevLen()}
\end{figure}

\begin{figure}
	\center{\includegraphics[scale=1]{inc/img/LevLenRecMemory}}
	\caption{Оценка памяти алгоритма LevLenRec()}
\end{figure}

\begin{figure}
	\center{\includegraphics[scale=1]{inc/img/LevLenRecCashMemory}}
	\caption{Оценка памяти алгоритма LevLenRecCash()}
\end{figure}

\begin{figure}
	\center{\includegraphics[scale=1]{inc/img/DamLevLenRecMemory}}
