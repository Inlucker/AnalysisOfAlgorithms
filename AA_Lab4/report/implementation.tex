...
\begin{figure}[h]
	\center{\includegraphics[width=1\linewidth]{inc/img/start}}
	\caption{Начальное положение ландшафта}
	\label{start}
\end{figure}

\begin{figure}
	\center{\includegraphics[width=1\linewidth]{inc/img/move}}
	\caption{Трёхмерный перенос ландшафта}
	\label{move}
\end{figure}

\begin{figure}
	\center{\includegraphics[width=1\linewidth]{inc/img/scale}}
	\caption{Трёхмерное масштабирование ландшафта}
	\label{scale}
\end{figure}

\begin{figure}
	\center{\includegraphics[width=1\linewidth]{inc/img/rotate}}
